...
export const SAMPLE_COMIC_REPORT_DATA: ReportData = {
  ...
  parameterScores: [
    ...
    // ============= COMIC-SPECIFIC PARAMETERS (12 parameters) =============
    {
      parameterId: 'comic-1',
      ...
      evidence: [{ type: 'scene', reference: 'Page 1, Splash', explanation: 'Full page aerial view establishes world with cinematic scope' }]
    },
    {
      parameterId: 'comic-2',
      ...
      evidence: [{ type: 'structure', reference: 'Pages 2-4', explanation: 'Transitions from wide establishing shots to intimate close-ups to action sequences' }]
    },
    {
      parameterId: 'comic-3',
    ...
    },
    {
      ...
      evidence: [{ type: 'dialogue', reference: 'Page 2', quote: 'I used to protect the powerful. Now I protect the forgotten.', explanation: 'Economic caption establishes character without redundant visuals' }]
    },
    {
      parameterId: 'comic-5',
      ...
      evidence: [{ type: 'scene', reference: 'Page 1', quote: 'Towering mega-structures pierce neon-drenched clouds. Holographic advertisements flicker between buildings.', explanation: 'Detailed environment descriptions provide clear visual direction' }]
    },
    {
      parameterId: 'comic-6',
      ...
      evidence: [{ type: 'character', reference: 'Kenji description', explanation: 'Iconic visual elements that will translate to memorable comic book imagery' }]
    },
    {
      parameterId: 'comic-7',
      ...
      evidence: [{ type: 'action', reference: 'Page 3, Panel 5', quote: 'Kenji EXPLODES into motion. The katana ignites—a blade of pure plasma energy.', explanation: 'Dynamic action direction with specific visual effects' }]
    },
    {
      parameterId: 'comic-8',
      ...
      evidence: [{ type: 'structure', reference: 'Overall premise', explanation: 'Clear genre fusion with established audience appeal' }]
    },
    {
      parameterId: 'comic-9',
    ...
    },
    {
      ...
      evidence: [{ type: 'structure', reference: 'Overall', explanation: 'Visual style and themes align with successful properties in the space' }]
    }
  ],
  insights: [
    {
