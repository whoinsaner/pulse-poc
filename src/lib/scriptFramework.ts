...
export const CORE_AGENTS: AgentDefinition[] = [
  ...
  },
  {
    ...
    name: 'Theme & Meaning',
    category: 'analysis',
    description: 'Extracts thematic spine and evaluates depth and resonance',
    parameters: ['thematic_spine_clarity', 'show_vs_tell_ratio', 'symbol_motif_consistency', 'moral_complexity', 'cultural_resonance', 'longevity_of_meaning'],
